...
public class TextField extends Component<Integer> {
    ...
    private Color4 textCol;
    
    private Color4 cursorCol;
    private int cursorPos;
    
    public TextField(Vec2 pos, Vec2 dim, int scale, GUIFont font, int format, Color4 textColor, Color4 border, Color4 fill, Color4 cursorColor){
        ...
        text = new Label(txtDraw, scale, font, "Grant Vandomelen", format, textCol);
    }
    
    public TextField(Vec2 pos, Vec2 dim, int scale, GUIFont font, int format, Color4 border, Color4 fill){
        
        this(pos, dim, scale, font, format, Color4.BLACK, border, fill, Color4.BLACK);
    }
